...
echo "# N = int(input())" >> "$1"/e.py
echo "# N = int(input())" >> "$1"/f.py
...
echo "# a_li = list(map(int, input().split()))" >> "$1"/e.py
echo "# a_li = list(map(int, input().split()))" >> "$1"/f.py
...
echo "# N, M = map(int, input().split())" >> "$1"/e.py
echo "# N, M = map(int, input().split())" >> "$1"/f.py
